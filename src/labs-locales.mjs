  ...
  it: {
    "careeros-local": localize("careeros-local", {
      ...
      delivery: {
        ...
        paragraphs: [
          "I controlli della release v1.9.0 hanno superato 1.532 test backend con 4 skip previsti e branch coverage dell’81,42%, oltre a 396 test frontend in 70 file. L’albero di release ha superato tutti i 17 test Rust. Le suite di migrazione e archivio coprono lo schema delle bozze, il formato v6 e il ripristino dalla v1 alla v5.",
      ...
      result: {
        ...
        paragraphs: [
          ...
          "L’app desktop autenticata ora gestisce le autorizzazioni per sette comandi agente e strumenti MCP in sola lettura, autenticati tramite bearer. Codex, Claude Code e script shell possono consultare una vista volutamente ridotta di un solo account autorizzato, ma non possono modificare il vault, invocare prompt liberi o aprire un trasporto remoto.",
  ...
  de: {
    "careeros-local": localize("careeros-local", {
      ...
      delivery: { title: "Wie das Produkt verifiziert wird", paragraphs: [
        "Die Release-Prüfungen für v1.9.0 bestanden 1.532 Backend-Tests mit 4 erwarteten Übersprüngen und 81,42% Branch Coverage sowie 396 Frontend-Tests in 70 Dateien. Der Release-Stand bestand alle 17 Rust-Tests. Migrations- und Archiv-Suites decken das Entwurfsschema, Archiv v6 und die Wiederherstellung der Formate v1 bis v5 ab.",
      ...
      result: { title: "Was heute vorhanden ist", paragraphs: [
        ...
        "Die authentifizierte Desktop-App verwaltet nun Berechtigungen für sieben schreibgeschützte, per Bearer authentifizierte Agentenbefehle und MCP-Werkzeuge über stdio. Codex, Claude Code und Shell-Skripte können eine bewusst kleine Ansicht eines autorisierten Kontos lesen, aber weder den Tresor ändern noch freie Prompts aufrufen oder einen entfernten Transport öffnen.",
  ...
  fr: {
    "careeros-local": localize("careeros-local", {
      ...
      delivery: { title: "Comment le produit est vérifié", paragraphs: [
        "Les contrôles de la version v1.9.0 ont réussi 1 532 tests backend avec 4 skips attendus et 81,42 % de couverture de branches, ainsi que 396 tests frontend dans 70 fichiers. L’arbre de publication a réussi les 17 tests Rust. Les suites de migration et d’archive couvrent le schéma des brouillons, le format v6 et la restauration des formats v1 à v5.",
      ...
      result: { title: "Ce qui existe aujourd’hui", paragraphs: [
        ...
        "L’application de bureau authentifiée gère maintenant les autorisations de sept commandes d’agent et outils MCP en lecture seule, authentifiés par bearer. Codex, Claude Code et les scripts shell peuvent consulter une vue volontairement réduite d’un compte autorisé, mais ne peuvent ni modifier le coffre, ni invoquer de prompts libres, ni ouvrir de transport distant.",

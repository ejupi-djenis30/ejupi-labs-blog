export const editorialUi = {
  en: {
    ...
    searchFallback: "Full-text search is unavailable. Matching the visible summaries instead.",
    emptyTitle: "No case study matches this search.",
    emptyBody: "Try a broader phrase or a different term.",
  ...
  it: {
    ...
    searchFallback: "La ricerca completa non è disponibile. Cerco nei riepiloghi visibili.",
    emptyTitle: "Nessun case study corrisponde alla ricerca.",
    emptyBody: "Prova una frase più ampia o un termine diverso.",
  ...
  de: {
    ...
    searchFallback: "Die Volltextsuche ist nicht verfügbar. Sichtbare Zusammenfassungen werden durchsucht.",
    emptyTitle: "Keine Fallstudie entspricht dieser Suche.",
    emptyBody: "Versuchen Sie einen allgemeineren oder einen anderen Begriff.",
  ...
  fr: {
    ...
    searchFallback: "La recherche intégrale est indisponible. Recherche dans les résumés visibles.",
    emptyTitle: "Aucune étude de cas ne correspond à cette recherche.",
    emptyBody: "Essayez une expression plus large ou un autre terme.",

...
const assetBudgets = [
  ...
  ["browser CSS", stylesheetBytes, 56_000],
  ...
  ["conservative first-load payload", firstLoadBytes, 180_000],
];
...
if (errors.length > 0) {
  ...
  console.log(
    `Validated ${files.length} files, ${canonicalPageCount} canonical pages, ${localeOrder.length} locales and ${caseDefinitions.length} case-study routes. Asset budgets: first load ${firstLoadBytes}/180000 bytes; JS ${browserJavaScriptBytes}/13000; CSS ${stylesheetBytes}/56000.`,
  );
}
